exports.map = { 
    ...
    contact: element.all(by.css('[formcontrolname="contactNumber"]')) ,
    password: element.all(by.css('[formcontrolname="password"]')) ,
    confirmPassword: element.all(by.css('[formcontrolname="confirmPassword"]')) ,
    accountNumber: element.all(by.css('[formcontrolname="accountNumber"]')) ,
    bank: element.all(by.css('[formcontrolname="bank"]')) ,
    paymentCycle: element.all(by.css('[formcontrolname="paymentCycle"]')) ,
