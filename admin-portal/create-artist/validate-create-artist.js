...
describe('Validiting fields on create artist - admin portal page',function(){
    ...
    it('should be able to direct to create artist page',function(){
        ...
        //helper.clickUsingElement("",element.all(by.css('[href="#/artist/create"]')));
        browser.get(serverURL+"#/artist/create");
        expect(browser.getCurrentUrl()).toEqual(serverURL+"#/artist/create");
    });
